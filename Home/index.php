...
<div id="main-flow">
    ...
    <div id="wrapper">
        ...
        <div class="item" id="i1" style="background-color:#3cb2c6 !important;">
            <div class="tileClose">&#x2715;</div>
                <div class="tile_icon"><img src="../SVG/phone-contact.svg"/> </div>
                <div class="tileTitle">APPOINTMENTS</div>
        </div>
        ...
        <div class="item" id="i2" style="background-color:#b2cf1e !important;">
            <div class="tileClose">&#x2715;</div>
            <div align="center" class="tile_icon">
                <img src="../SVG/phonendoscope.svg"/>
            </div>
            <div class="tileTitle">
                DOCTORS
            </div>
            <div class="tileIframeWrapper">
                <iframe class="tileIframe" src="../docs_frame/index.php"></iframe> 
            </div>
        ...
        <div class="item" id="i3" style="background-color:#62615f !important;">
            ...
            <div class="tileTitle">PRESCRIPTION</div>
        ...
        <div class="item" id="i4" style="background-color:#424b5a !important;">
            ...
            <div class="tileTitle">MEDICINES</div>
            <div class="item_content"></div>
        </div>
        <div class="item" id="i5" style="background-color:#2abab3 !important;">
            ...
            <div class="tileTitle">HISTORY</div>
        ...
        <div class="item" id="i6" style="background-color:#f7644e !important;">
            ...
            <div class="tileTitle">MED FARMS</div>
            <div class="item_content"></div>
        </div>
        <div class="item" id="i7" style="background-color:#edb22b !important;">
            ...
            <div class="tileTitle">HOSPITALS</div>
            <div class="item_content"></div>
        </div>
    ...
    <div id="feed_box">
        <div class="feed">
            <div class="feed_header"><a href="#">Feed Header text</a></div>
